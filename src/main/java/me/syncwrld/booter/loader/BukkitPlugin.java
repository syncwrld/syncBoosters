package me.syncwrld.booter.loader;
...
import me.syncwrld.booter.tool.LocationSerializer;
...
public abstract class BukkitPlugin extends JavaPlugin {
    ...
    protected final Gson gson = Constants.GSON;
    ...
    public void log(String colorCode, String message) {
        this.log(String.format("§%s %s", colorCode, message));
    }
    ...
    public FileConfiguration getConfig() {
        this.configuration = YamlConfiguration.loadConfiguration(new File(this.getDataFolder(), "configuration.yml"));
